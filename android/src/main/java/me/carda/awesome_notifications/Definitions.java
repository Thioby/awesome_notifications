...
public interface Definitions {
  ...
  String NOTIFICATION_SCHEDULE_ERA = "era";
    ...
    String NOTIFICATION_SCHEDULE_REPEATS = "repeats";String NOTIFICATION_CREATED_SOURCE = "createdSource";
  ...
  Map<String, Object> initialValues = new HashMap<String, Object>() {{
    ...
    put(Definitions.NOTIFICATION_SCHEDULE_REPEATS, true);put(Definitions.NOTIFICATION_ID, 0);
